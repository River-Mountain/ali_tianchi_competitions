# coding: utf-8
# @Time    : 2017/11/1 下午3:56
# @Author  : Youqiang He
"""
divide data except double twelve by week to three division: train, test, preidct
"""
...
# construct features by three basic dimensions: user, item, category
# three division: train, test, preidct
...
###########################################################################
"""
Step 1: divide the dataset to 3 part

	part 1 - train: 11.22~11.27 > 11.28;
	part 2 - test: 11.29~12.04 > 12.05;
	part 3 - predict: 12.13~12.18 (> 12.19);
